...
var processEdges = function processEdges(edges) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {
    ...
    loop: 10
      ...
      _ref$poly = _ref.poly,
      poly = _ref$poly === void 0 ? 30 : _ref$poly,
      _ref$loop = _ref.loop,
  ...
  edgeGroups.forEach(function (edges) {
    if (edges.length > 1) {
      ...
      edges.forEach(function (edge, i) {
        ...
        edge.style = Object.assign(Object.assign({}, edge.style), {
          keyshape: Object.assign(Object.assign({}, (_a = edge.style) === null || _a === void 0 ? void 0 : _a.keyshape), keyshapeStyle)
        });
