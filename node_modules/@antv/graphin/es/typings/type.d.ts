...
export declare type NodeStyleLabel = Partial<{
    /**
     * @description  标签名称，\n 可换行
...
export declare type NodeStyleIcon = Partial<{
...
export declare type NodeStyleBadge = Partial<{
...
export declare type NodeStyleKeyShape = Partial<{
    /** 节点的大小 */
    size: number;
    /** 填充色 */
    fill: string;
...
export declare type NodeStyleHalo = Partial<{
    /** 大小 */
    size: number | number[];
    /** 填充色 */
    fill: string;
